...
![](..\images\2015-10-03-css-11.png) 

或者还有下面这种写法：

![](..\images\2015-10-03-css-12.png) 

上面的这种写法，`<h3>`标签和`<i>`标签并不是紧挨着的，但他们保持着一种后代关系。

还有下面这种写法：（含类选择器、id 选择器都是可以的）

![](..\images\2015-10-03-css-13.png) 
...
选择的元素要求同时满足两个条件：必须是 h3 标签，然后必须有 special 类样式 。
