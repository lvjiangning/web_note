...
![](..\images\20170729_1722.png) 

此时，如果给这两个div增加一个浮动属性，比如`float: left;`，效果如下：

![](..\images\20170729_1723.png) 
...
![](..\images\20170801_2152.png) 


给div设置一个正确的合适的高度（至少保证高度大于儿子的高度），就可以看到正确的现象：

![](..\images\20170801_2153.png) 
...
![](..\images\20170801_2200.png) 


![](..\images\20170801_2201.png) 
...
![](..\images\20170802_1716.png) 

（2）可如果在此基础之上，给p设置浮动，却发现父亲div没有高度了：

![](..\images\20170802_1730.png) 

（3）此时，我么可以在div的里面放一个div（作为内墙），就可以让父亲div恢复高度：

![](..\images\20170802_1812.png) 

于是，我们采用内墙法解决前言中的问题：

![](..\images\20170802_1834.png) 
...
![](..\images\20170804_1920.png) 


那么对于前言中的例子，我们同样可以使用这一属性：

![](..\images\20170804_1934.png) 
